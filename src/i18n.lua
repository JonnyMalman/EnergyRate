...
phrases = {
    ...
    pt = {
        ...
        ["OperatorCost"] = "Custo do operador",
        ["GridLosses"] = "Custo percentual de perdas de rede",
        ["GridAdjustment"] = "Custo percentual de ajuste",
        ["DealerCost"] = "Custo do revendedor",
        ["GridCost"] = "Custo da rede local",
    ...
    sv = {
        ...
        ["EnergyRateUpdate"] = "ENTSO-e Spotpriser senast uppdaterad",
